...
3) Access the `workbench` named `audio-to-text-j1731928799699-notebook`.
...
5) In the terminal, run `cd audio-to-text-j1731928799699` to navigate to your sample app's directory.
